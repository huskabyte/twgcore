...
/**
 * Dog - SolarAlpha Created using Tabula 7.0.0
 */
public class ModelLabrador extends ModelBase {
	...
	public ModelLabrador() {
		...
		this.Pivot.setRotationPoint(0.0F, 15.0F, -9.0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		GlStateManager.translate(this.Pivot.offsetX, this.Pivot.offsetY, this.Pivot.offsetZ);
		GlStateManager.translate(this.Pivot.rotationPointX * f5, this.Pivot.rotationPointY * f5,
				this.Pivot.rotationPointZ * f5);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		if (!((EntityLabrador) entityIn).isSitting()) {
			...
			this.LBackLeg1.rotateAngleX = (float) (MathHelper.cos(-limbSwing * 0.6662F) * 1.4F * -limbSwingAmount
					- (10 * Math.PI / 180));
			this.RBackLeg1.rotateAngleX = (float) (MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount
					- (10 * Math.PI / 180));
			...
			this.LBackLeg2.rotateAngleX = (float) ((float) -(MathHelper.cos(limbSwing * 0.6662F) * 0.7F
					* -limbSwingAmount) + (10 * Math.PI / 180));
			this.RBackLeg2.rotateAngleX = (float) ((float) -(MathHelper.cos(limbSwing * 0.6662F) * 0.7F
					* limbSwingAmount) + (10 * Math.PI / 180));
		}

		if (!((EntityLabrador) entityIn).isTrick3()) {
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount,
		...
		if (thisEntity.isSitting()) {
			if (thisEntity.isTrick2()) {
				
				this.Pivot.setRotationPoint(0.0F, 18.0F, -9.0F);

				this.Neck.rotateAngleX = (float) (48.75F * Math.PI / 180);
				this.Head.rotateAngleX = (float) (-40.08F * Math.PI / 180);

				this.Pivot.rotateAngleX = (float) (0.0F * Math.PI / 180);
				...
				this.RLeg3.rotateAngleX = (float) (-71.56F * Math.PI / 180);
				...
				this.RLeg3_1.rotateAngleX = (float) (-71.56F * Math.PI / 180);
				...
				// =============END DOWN ANIMATION==============
				// ===========START SITPR ANIMATION=============
				if (thisEntity.isTrick3()) {
					
					this.Pivot.setRotationPoint(0.0F, 9.0F, 0.0F);

					this.Neck.rotateAngleX = (float) (76.75F * Math.PI / 180);
					this.Neck.rotateAngleY = 0F;
					this.Head.rotateAngleX = (float) (99.08F * Math.PI / 180);

					this.Pivot.rotateAngleX = (float) (-88.0F * Math.PI / 180);
					this.Body.rotateAngleX = (float) (2.0F * Math.PI / 180);
					this.BUTT.rotateAngleX = (float) (-4F * Math.PI / 180);

					this.RBackLeg1.rotateAngleX = (float) (-22.0F * Math.PI / 180);
					...
					this.LBackLeg1.rotateAngleX = (float) (-22.0F * Math.PI / 180);
					...
					this.Pivot.setRotationPoint(0.0F, 15.0F, -6.0F);
