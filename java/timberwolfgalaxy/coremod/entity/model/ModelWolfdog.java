 ...
 */
public class ModelWolfdog extends ModelBase {
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		if (!((EntityWolfdog) entityIn).isSitting()) {
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount,
		...
		if (((EntityWolfdog) entitylivingbaseIn).isSitting()) {
			if(((EntityWolfdog) entitylivingbaseIn).isTrick2()){
			...
			}else if(((EntityWolfdog) entitylivingbaseIn).isTrick3()) {
